...
training_data = "tunnels-nexus5"
test_data = "nexustunnels2"
...
#for i in closest_list:
    #ax.add_line(Line2D([i[0][0], i[1][0]], [-float(i[0][1]), -float(i[1][1])]))
    #print([i[0][0], -float(i[0][1])], [float(i[1][0]), -float(i[1][1])])
plt.title('Tunnels Closest Points Test by # APs Matched with Averaging')
plt.ylabel('y coordinate (map pixles)')
plt.xlabel('x coordinate (map pixles)')
plt.plot()
...
#for i in closest_list:
    #ax.add_line(Line2D([i[0][0], i[1][0]], [-float(i[0][1]), -float(i[1][1])]))
    #print([i[0][0], -float(i[0][1])], [float(i[1][0]), -float(i[1][1])])
plt.title('Tunnels Closest Points Test by Euclidian Metric')
plt.ylabel('y coordinate (map pixles)')
plt.xlabel('x coordinate (map pixles)')
plt.plot()
...
#for i in closest_list:
    #ax.add_line(Line2D([i[0][0], i[1][0]], [-float(i[0][1]), -float(i[1][1])]))
    #print([i[0][0], -float(i[0][1])], [float(i[1][0]), -float(i[1][1])])
plt.title('Tunnels Closest Points Test by Euclidian Metric with Averaging')
plt.ylabel('y coordinate (map pixles)')
plt.xlabel('x coordinate (map pixles)')
plt.plot()

plt.figure(1)
plt.savefig(training_data+test_data+'_test_bit')
plt.figure(2)
